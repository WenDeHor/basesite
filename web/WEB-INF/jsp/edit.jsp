<%@ page import="com.base.network.model.ContactType" %>
...
+
<%@ page import="com.base.network.model.SectionType" %>
+
<%@ page import="com.base.network.util.DateUtil" %>
<html>
<head>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.base.network.model.Organization.Position"/>
                                <dl>
